...
// axious get
axios.get("https://api.github.com/users/Aakak").then(data => {
  const myProfile = data.data;
  console.log("UserProfile", myProfile);
  const cards = document.querySelector(".cards");
  const cardInfo = cardCreator(myProfile);
...
function cardCreator(param) {
  ...
  const aProfileLink = param.html_url;
  profileLink.innerHTML = aProfileLink.link(param.html_url);
